...
\begin{document}
	...
	Uniform ergodicity ensures the existence of a Central Limit Theorem for $\bar{g}_m$ whenever $E_\pi |g|^2 < \infty$ \cite{Jones.2004b}, that is,
	...
	\begin{proof}
		...
		The case $x>x_b^*$ can be shown similarly. Figure \ref{fig:gam1} illustrates these two results.
	\end{proof}
